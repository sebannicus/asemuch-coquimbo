    ...
    <ProtectedAdminPage>
      <section className="space-y-6 rounded-3xl border border-[#d9e6f5] bg-white p-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-[#0c71c3]">Convenios</p>
            <h2
            ...
            <p className="mt-2 max-w-2xl text-sm text-[#5d6675]">
              Dejé la ruta lista para conectar la carga del convenio, su imagen y su vigencia en la siguiente etapa.
            </p>
          </div>
          <Link
